                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                ...
                                @if(isset($object) && $object->slug)
                                    <div class="form-group">
                                        <a target="_blank" href="{{ _getPostLink($object) }}" class="btn btn-default" type="button">{{ asset(_getPostLink($object)) }}</a>
                                    </div>
                                @endif
                                <div class="form-group">
                            ...
                            <div class="portlet-body">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="1" {{ (isset($object) && $object->global_status == 1) ? 'selected' : '' }}>
                                            Published
                                        </option>
                                        <option value="0" {{ (isset($object) && $object->global_status == 0) ? 'selected' : '' }}>
                                            Disabled
                                        </option>
                                        <option value="2" {{ (isset($object) && $object->global_status == 2) ? 'selected' : '' }}>
                                            Draft
                                        </option>
                                    </select>
                                </div>
