    ...
    <div class="container">
        ...
        <ul class="admin-navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a target="_blank" href="/{{ $adminCpAccess }}/pages/edit/0">
                            Page
                        </a>
                    </li>
                    <li>
                        <a target="_blank" href="/{{ $adminCpAccess }}/posts/edit/0">
                            Post
                        </a>
                    </li>
                    <li>
                        <a target="_blank" href="/{{ $adminCpAccess }}/categories/edit/0">
                            Category
                        </a>
                    </li>
                    <li>
                        <a target="_blank" href="/{{ $adminCpAccess }}/products/edit/0">
                            Product
                        </a>
                    </li>
                    <li>
                        <a target="_blank" href="/{{ $adminCpAccess }}/product-categories/edit/0">
                            Product category
                        </a>
                    </li>
                    <li class="divider"></li>
