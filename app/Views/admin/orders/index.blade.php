    ...
    <script>
        $(document).ready(function(){
            TableDatatablesAjax.init({
                ajaxGet: '{{ asset($adminCpAccess.'/orders') }}',
                src: $('#datatable_ajax'),
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a class="btn btn-transparent btn-success btn-circle btn-sm active" href="{{ asset($adminCpAccess.'/product-categories/edit/0/') }}"><i class="fa fa-plus"></i> Create</a>
                        </div>
                    </div>
                </div>
