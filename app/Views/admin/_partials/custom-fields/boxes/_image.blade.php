    ...
    <div class="scf-image-wrap">
        <div class="select-media-box">
            ...
            <a title="" class="show-add-media-popup">
                <img src="{{ $imgSrc or '' }}" alt="" class="img-responsive">
            </a>
            <input type="hidden" data-slug="{{ $fieldItem->slug or '' }}" data-fieldtype="{{ $fieldItem->field_type or '' }}" value="{{ $theMeta or '' }}" class="input-file-customs-field">
